...
const FILE_TYPES = {
  ...
  CLR:  { description: "RAW terrain texture/color",  icon: "🖼" },
  CL0:  { description: "Terrain color layer 0",      icon: "📄" },
  CL1:  { description: "Terrain color layer 1",      icon: "📄" },
  CL2:  { description: "Terrain color layer 2",      icon: "📄" },
  CL3:  { description: "Terrain color layer 3",      icon: "📄" },
  CL4:  { description: "Terrain color layer 4",      icon: "📄" },
  CL5:  { description: "Terrain color layer 5",      icon: "📄" },

  // Terrain / heightmap
  RA0:  { description: "Terrain height/collision layer 0", icon: "📄" },
  RA1:  { description: "Terrain height/collision layer 1", icon: "📄" },
  RA2:  { description: "Terrain height/collision layer 2", icon: "📄" },
  RA3:  { description: "Terrain height/collision layer 3", icon: "📄" },
  RA4:  { description: "Terrain height/collision layer 4", icon: "📄" },
  RA5:  { description: "Terrain height/collision layer 5", icon: "📄" },
  LTE:  { description: "Terrain lighting data",      icon: "📄" },
  GRM:  { description: "Terrain geometry data",      icon: "📄" },

  // 3D models
  BIN:  { description: "3D model (BIN mesh)",        icon: "📦" },
  LWO:  { description: "LightWave 3D object",        icon: "📦" },
  ANI:  { description: "Animation data",             icon: "📄" },
  ...
  TTX:  { description: "Track texture index",        icon: "📄" },
  ...
  MAP:  { description: "Map/minimap data",           icon: "📄" },
  ...
  TEX:  { description: "Texture list",               icon: "📄" },
